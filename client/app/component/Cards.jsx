      ...
      <div className="py-10 font-Lato">
        <div className="grid md:grid-cols-3 w-full text-black gap-3 items-center justify-center lg:px-[8rem]">
          {testimonialData.map((data, id) => {
            return (
              <div
                className="hover:cursor-pointer w-[20rem] sm:w-[15rem] sm:h-[26rem] lg:w-[17rem] lg:h-[24rem] bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl shadow-lg border border-white border-opacity-20 "
                key={id}
              >
                <div
